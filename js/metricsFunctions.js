...
function chartCtrl($scope, $http) { //main controller for stock page
  ...
  $http.post($scope.url).
      success(function(data,status) {
              ...
              $scope.data2= data[1];
              $scope.data = $scope.data.concat($scope.data2);

              var chart3 = AmCharts.makeChart("chart3div", { //pie chart
                "type": "pie",
                "startDuration": 0.5,
                 "theme": "dark",
                "addClassNames": true,
  ...
  var chart = AmCharts.makeChart("chartdiv", { //Big data chart
    "type": "serial",
    "theme": "dark",
    "marginRight": 40,
    "marginLeft": 40,
...
var chart2 = AmCharts.makeChart( "chart2div", { //vertical bar chart
  "type": "serial",
  "theme": "dark",
  "dataProvider": [ {
    "country": "Sample",
...
var chart4 = AmCharts.makeChart("chart4div", { //horizontal bar chart
	"type": "serial",
     "theme": "dark",
	"categoryField": "year",
	"rotate": true,
